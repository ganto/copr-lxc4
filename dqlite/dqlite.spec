...
%build
autoreconf -fiv
%configure --enable-static=no --enable-build-raft=yes --verbose
%make_build
...
%changelog
* Fri Jan 31 2025 Reto Gantenbein <reto.gantenbein@linuxmonk.ch> 1.17.2-0.1
- Update to 1.17.2.

* Sun Nov 03 2024 Reto Gantenbein <reto.gantenbein@linuxmonk.ch> 1.17.1-0.1
- Update to 1.17.1.
